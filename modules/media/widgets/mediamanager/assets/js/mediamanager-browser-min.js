...
return
var uploaderOptions={clickable:this.$el.find('[data-control="upload"]').get(0),url:this.options.url,paramName:'file_data',headers:{},timeout:0,createImageThumbnails:false}
...
$.oc.mediaManager.imageCropPopup=MediaManagerImageCropPopup}(window.jQuery);+function($){"use strict";if($.oc.mediaManager===undefined)
$.oc.mediaManager={}
var Base=$.oc.foundation.base,BaseProto=Base.prototype
